  ...
  return (
    <div>
        ...
        <Container>
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="flex-1 text-center lg:text-left">
              <div className="mb-4">
                <span className="text-xs font-body font-medium text-w1it-blue bg-blush px-3 py-1.5 rounded-full">
                  macOS • Design Tools
                </span>
              </div>
              <h1 className="font-heading font-bold text-4xl md:text-5xl lg:text-6xl text-w1it-charcoal mb-6">
                Pixel Color Picker
              </h1>
              <p className="text-lg md:text-xl text-w1it-gray-600 mb-8 font-body">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                ...
                <div className="text-center sm:text-left">
                  <div className="inline-block px-4 py-2 bg-green-100 rounded-lg">
                    <span className="text-sm font-body font-medium text-w1it-green">
                      Available now
                    </span>
                  </div>
                </div>
      ...
      <section className="py-20 md:py-32">
        <Container>
          <h2 className="font-heading font-bold text-3xl md:text-4xl text-w1it-charcoal text-center mb-16">
            Everything You Need
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {features.map((feature, index) => (
              ...
              >
                ...
                <h3 className="font-heading font-semibold text-xl text-w1it-charcoal mb-3">
                  {feature.title}
                </h3>
                <p className="text-w1it-gray-600 font-body">{feature.description}</p>
              </Card>
            ))}
          </div>
        </Container>
      ...
      <section className="py-20 md:py-32 bg-blush">
        <Container>
          <div className="text-center">
            <h2 className="font-heading font-bold text-3xl md:text-4xl text-w1it-charcoal mb-4">
              Ready to Transform Your Workflow?
            </h2>
            <p className="text-lg text-w1it-gray-600 mb-8 font-body">
