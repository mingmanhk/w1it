...
export default function CookieConsent() {
  ...
  useEffect(() => {
    ...
    if (!consent) {
      // eslint-disable-next-line react-hooks/set-state-in-effect -- client-only init from localStorage, runs once
      setShowConsent(true);
    }
  }, []);
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-navy/95 backdrop-blur-sm text-white p-4 z-50 border-t border-white/10">
